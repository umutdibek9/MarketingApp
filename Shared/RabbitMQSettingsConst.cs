...
namespace Shared
{
    public class RabbitMQSettingsConst
    {
        ...
        public const string PaymentStockReservedEventQueueName = "payment-storck-reserved";
        ...
        public const string CargoArrivedEventQueueName = "cargo-arrived-queue";
        public const string CargoFailedEventQueueName = "cargo-failed-queue";
    }
}
